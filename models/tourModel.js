...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxlength: [40, 'A tour name must have equal or more then 40 characters'],
    ...
    priceDiscount: {
      ...
      validate: function (val) {
        // this only points to current doc on creating new document
...
tourSchema.virtual('durationWeeks').get(function () {
  // since arrow function doesn't have this keyword
